...
async def play_tg_file(c: Client, m: Message, replied: Message = None, link: str = None):
    ...
    if replied.video or replied.document:
        ...
        if not link:
            ...
            loser = await replied.reply("⚡...تحميل ملف...")

        else:

            loser = await m.reply("⚡...تحميل ملف...")
        ...
        if chat_id in QUEUE:
            ...
            try:
                ...
                await m.reply_photo(
                    ...
                    caption=f"-› **الاسم** [{songname}]({link}) | `فيديو`\n"
                ...
                await m.reply_text("⚡ مفيش كول اكتب.\n\n» دي .فتح كول وحاول مره اخرى !")
    ...
    try:
        ...
        if b.status == "banned":
            ...
            try:
                ...
                await m.reply_text("المساعد محظور ، ارفع الحظر عنة واكتب .تحديث وبعدين اكتب .انضم حتى تعرف تشغل 🤍")
                        ...
                        if chat_id in QUEUE:
                            ...
                            try:
                                ...
                                await m.reply_photo(
                                    ...
                                    caption=f"-› **الاسم** [{songname}]({url}) | `الفيديو`\n-› **المده** `{duration}`\n-› **طلب من** {requester}",
